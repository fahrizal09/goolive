...
<div class="main-panel">
        ...
        <div class="row">
            <div class="col-lg-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h2 style="color: #1E7BCB;"> Kategori</h2><br>
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <?php echo $a->nama_kategori_brg; ?>
                          </td>
                          <td>
                            <center><a onclick="return confirm_alert(this);" href="<?php echo base_url('Admin/Barang/hapuskategori/'.$a->id_kategori); ?>"><button type="button" class="btn btn-danger"><i class="menu-icon mdi mdi-delete"></i> Hapus</button></a></center>
                          </td>
                        </tr>
                        <?php } ?>
                      </tbody>
